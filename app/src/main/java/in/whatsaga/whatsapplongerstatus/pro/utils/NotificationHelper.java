...
import in.whatsaga.whatsapplongerstatus.pro.App;
import in.whatsaga.whatsapplongerstatus.pro.R;
import in.whatsaga.whatsapplongerstatus.pro.notification.NotificationActionReceiver;
...
public class NotificationHelper {
    ...
    public static void showMessageNotification(Context context, String title, String text, int id, Bitmap largeIcon, int badgeCount, String pack) {
        ...
        Intent resultIntent = ChatActivity.getStartIntent(context, title, pack, true);
    ...
    public static void showFileDeleted(Context context, String deletedFilePath) {
        ...
        if (Common.isVideoFile(deletedFilePath)) {
