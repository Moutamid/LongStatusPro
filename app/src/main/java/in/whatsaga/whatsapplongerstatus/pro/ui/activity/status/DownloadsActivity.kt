...
class DownloadsActivity : AppCompatActivity(), StatusAdapter.OnItemClick, View.OnClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list = ArrayList()
        path = Common.Statusbackupfolder
    ...
    private fun getList() {
        ...
        adapter = StatusAdapter(this, list, this, Constants.SAVED)
    ...
    fun delete(launcher: ActivityResultLauncher<IntentSenderRequest>?, uri: Uri) {
        val contentResolver = this@DownloadsActivity.contentResolver
        try {
