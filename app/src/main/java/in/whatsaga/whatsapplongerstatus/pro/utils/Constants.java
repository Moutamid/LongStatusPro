...
public class Constants {
    ...
    public static final String WEEKLY_IN_WHATSAGA_WHATSAPPLONGERSTATUS_PRO = "weekly.in.whatsaga.whatsapplongerstatus.pro";
    public static final String MONTHLY_IN_WHATSAGA_WHATSAPPLONGERSTATUS_PRO = "monthly.in.whatsaga.whatsapplongerstatus.pro";
    public static final String YEARLY_IN_WHATSAGA_WHATSAPPLONGERSTATUS_PRO = "yearly.in.whatsaga.whatsapplongerstatus.pro";
