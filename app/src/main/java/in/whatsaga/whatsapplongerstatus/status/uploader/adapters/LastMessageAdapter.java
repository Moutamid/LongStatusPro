...
import static in.whatsaga.whatsapplongerstatus.status.uploader.App.context;
...
import in.whatsaga.whatsapplongerstatus.status.uploader.utils.ImageUtils;
...
public class LastMessageAdapter extends RecyclerView.Adapter<LastMessageAdapter.LastMessageViewHolder> {
    ...
    public LastMessageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new LastMessageViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_message_item, parent, false
        ));
    }
