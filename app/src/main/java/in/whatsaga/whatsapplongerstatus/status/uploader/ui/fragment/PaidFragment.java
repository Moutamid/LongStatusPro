...
public class PaidFragment extends Fragment implements BillingProcessor.IBillingHandler {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        yearlySUB.setOnClickListener(v -> {
            bp.subscribe(requireActivity(), Constants.YEARLY_IN_WHATSAGA_WHATSAPPLONGERSTATUS_PRO);
        });

        monthlySUB.setOnClickListener(v -> {
            bp.subscribe(requireActivity(), Constants.MONTHLY_IN_WHATSAGA_WHATSAPPLONGERSTATUS_PRO);
        });

        weeklySUb.setOnClickListener(v -> {
            bp.subscribe(requireActivity(), Constants.WEEKLY_IN_WHATSAGA_WHATSAPPLONGERSTATUS_PRO);
        });
